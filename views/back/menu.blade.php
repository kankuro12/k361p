...
<ul class="navview-menu" style="height: calc(100vh - 68px);">
    ...
    <a href="/admin/board/list/">
            <span class="icon"><span class="mif-users"></span></span>
            <span class="caption">Board Members</span>
        </a>
    </li>

    <li>
    <a href="/admin/committe/list/">
            <span class="icon"><span class="mif-organization"></span></span>
            <span class="caption">Committes</span>
        </a>
    </li>
    ...
    <li>
    <a href="/admin/boardinfo/list/">
            <span class="icon"><span class="mif-notification"></span></span>
            <span class="caption">Private Info</span>
        </a>
    </li>
    ...
    <a href="/admin/area/list/">
            <span class="icon"><span class="mif-notification"></span></span>
            <span class="caption">Local Area Promot</span>
        </a>
    </li>
