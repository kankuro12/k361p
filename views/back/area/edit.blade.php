@extends('back.app')
@section('title','Loccal Area edit')
@section('content')
        ...
        <div class="cell-md-8" >
            <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text"  name="name" placeholder="Enter name of the place" value="{{$area->name}}" required/>
                    </div>
                   
                    <div class="form-group">
                        <label>Details</label>
                        <textarea data-role="textarea" name="detail">{{$area->detail}}</textarea>
                    </div>

                    <div class="form-group container" style="border: 1px black solid; padding-bottom:5px;" >
                        <p>Photo</p>
                        <img src="/{{$area->image}}" style="height: 200px;" id="photo"/>
