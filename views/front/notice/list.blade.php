            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="feature-wrapper mb-30">
                    <div class="feature-title-heading ">
                        <h3><a href="/propeace/notice/single/{{$notice->id}}/" class="">{{$notice->title}}</a></h3>
                        <span></span>
                    </div>
                    <div class="feature-text">
                        <p>{!!substr($notice->desc,0,300)!!}...</p>
                    </div>
                    <div style="padding:.7rem 0;">
                        <small class="text-warning pull-left" style="color: #f80!important;"><i
                                class="fa fa-calendar-plus-o" aria-hidden="true"></i> - {{$notice->published}}</small>
                        <small class="text-info pull-right" style="color: #f80!important;"><i class="fa fa-user-circle"
                                aria-hidden="true"></i> - {{$notice->publisher}}</small>
                    </div>
                </div>
                @endforeach
            </div>
