                        ...
                        @for($i=1;$i<count($news);$i++) <!-- Single News Area -->
                            <div class="single-news-area d-flex align-items-center">
                                ...
                                <div class="news-content">
                                    ...
                                    <div class="news-meta">
                                        <a href="#" class="post-author"><img src="/assets/front/img/core-img/pencil.png"
                                                alt=""> {{$news[$i]->publisher}}</a>
                                        <a href="#" class="post-date"><img src="/assets/front/img/core-img/calendar.png"
                                                alt="">{{substr($news[$i]->getdate()->format('F d'),0,3)}}</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Single News Area -->
