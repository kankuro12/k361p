                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-area mb-40">
                       <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <a href="#" class="post-author"><img src="/assets/front/img/core-img/pencil.png" alt="">  {{$news[0]->publisher}}</a>
                                <a href="#" class="post-date"><img src="/assets/front/img/core-img/calendar.png" alt="">  {{$news[0]->published}}</a>
                            </div>
                        </div>
                                            ...
                                            <div class="single-news-area d-flex align-items-center">
                                                ...
                                                <div class="news-content">
                                                    ...
                                                    <div class="news-meta">
                                                        ...
                                                        <a href="#" class="post-date"><img src="/assets/front/img/core-img/calendar.png" alt="">{{substr($news[$i]->getdate()->format('d F'),0,6)}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Single News Area -->
                                    ...
                                    To be alert
                                            ...
                                            @foreach($notices as $notice)
                                                <div class="feature-wrapper mb-30">
                                                    ...
                                                    <h3><a href="/mcci/notice/single/{{$notice->id}}/" class="">{{$notice->title}}</a></h3>
                                                    <span></span>
                                                    </div>
