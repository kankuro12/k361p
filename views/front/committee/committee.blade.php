@extends('front.app')
@section('title','propeace - Committee')
@section('content')
<style>
    .styl tr td a {
        display: block;
                ...
                <div class="single-blog-area mb-70">
                    ...
                    <div style="padding:2.4rem;">
                        <table class="table styl">
                            ...
                            <tr>
                                <td><a href="/propeace/committeemember/{{$committe->id}}/">{{$committe->name}}</a></td>
                                <td><a href="/propeace/committeemember/{{$committe->id}}/">Start From:-
                                        {{$committe->startdate}}</a></td>
                                <td><a href="/propeace/committeemember/{{$committe->id}}/">Status:-
