...
<?php $__env->startSection('title','Loccal Area edit'); ?>
        ...
        <div class="cell-md-8" >
            <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text"  name="name" placeholder="Enter name of the place" value="<?php echo e($area->name); ?>" required/>
                    </div>
                   
                    <div class="form-group">
                        <label>Details</label>
                        <textarea data-role="textarea" name="detail"><?php echo e($area->detail); ?></textarea>
                    </div>

                    <div class="form-group container" style="border: 1px black solid; padding-bottom:5px;" >
                        <p>Photo</p>
                        <img src="/<?php echo e($area->image); ?>" style="height: 200px;" id="photo"/>
...
<?php /* /home1/needtech/mechicci.org.np/views/back/area/edit.blade.php */ ?>