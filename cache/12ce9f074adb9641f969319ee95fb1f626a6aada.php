<?php $__env->startSection('title','propeace - Secretariat'); ?>
                ...
                <div class="col-12 col-lg-9">
                     <div style="line-hight:10px;">
                        <ul style="font-size: 15px;
                            ...
                            <li style="padding:4px 0;"><span class="text-dark">Designation </span>: <?php echo e($secretary->designation); ?></li>
...
<?php /* /home1/needtech/mechicci.org.np/views/front/secretary/list.blade.php */ ?>