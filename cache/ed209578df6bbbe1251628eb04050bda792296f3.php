 ...
 <section class="newsletter-area section-padding-100 bg-img jarallax" style="background-image: url(/assets/front/img/bg-img/6.jpg);">
        <div class="container">
                ...
                <div class="col-12 col-sm-10 col-lg-8">
                    <div class="nl-content text-center" id="hide">
                        ...
                        <form  method="post" id="mailing">
                            ...
                            <span onclick="addMail();"><p style="margin-top:.3rem; font-size:17px;"><b>Subscribe</b></p> </span>
                        </form>
...
<footer class="footer-area section-padding-100-0">
        <div class="container">
            <div class="row">
                    ...
                    <div class="single-footer-widget mb-100">
                        ...
                        <nav>
                            <ul >
                                        ...
                                        <li><a href="http://fncci.org/">Federation of Nepal Chamber of Commerce and Industry</a></li>
                                        ...
                                        <li><a href="http://www.moi.gov.np/">Government of Nepal</a></li>
                                         <li><a href="http://mos.gov.np/en/">Government of Nepal Ministry of Industry, Commerce and Supplies</a></li>
                                       <li><a href="http://www.tourism.gov.np/">Government of Nepal Ministry of Culture, Tourism and Civil Aviation</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                ...
                <p style="color:#ffffff;">Mechi Chamber of Commerce & Industry (propeace), Dhulabari, Jhapa, Nepal</p> 
                   <P style="color:#ffffff;">Tel:- 023-560035/560450</P>
                    <p style="color:#ffffff;">Fax No:- 00977-23560658</p>
                    <p style="color:#ffffff;">Website:- www.mechicci.org.np</p>
...
<?php /* /home1/needtech/mechicci.org.np/views/front/footer.blade.php */ ?>