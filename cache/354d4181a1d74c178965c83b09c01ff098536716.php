...
<?php $__env->startSection('title','Secretary listing'); ?>
    ...
    <div class="row" style=" padding:2rem;">
        <div class="cell-md-12" >    
            <table class="table table-border cell-border" data-role="table"  data-pagination-short-mode="true">
                ...
                <tbody>
                <?php $__currentLoopData = $secretaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><a class="button link" href="/admin/secretary/edit/<?php echo e($member->id); ?>/">Edit</a> || 
                        <a class="button link" href="/admin/secretary/del/<?php echo e($member->id); ?>/">Delete</a> </td>
                </tr>
...
<?php /* /home1/needtech/mechicci.org.np/views/back/secretary/list.blade.php */ ?>